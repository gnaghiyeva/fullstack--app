  ...
  return (
    <>
     ...
     <Box sx={{ flexGrow: 1, width: "90%", margin: "25px auto" }}>
      <Grid style={{display:'flex', justifyContent:'space-between'}} container spacing={2}>
    ...
    <Modal
      ...
      >
        <Box sx={style}>
          ...
          <TextField name="releaseYear" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.releaseYear} id="outlined-basic" type='number' label="Release Yaer" variant="outlined" />
            <Button type='submit' style={{marginTop:'10px'}} variant='contained' color='warning'>Post Song</Button>
            </div>
